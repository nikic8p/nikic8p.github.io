...
var text_p = new Array(data.length);
var z_data_p = new Array(data.length);
var y_data_p = new Array(data.length);
var x_data_p = new Array(data.length);


for (var i = 0; i<28; i++) {
    x_data_p[i] = data[i]["principal component 1"];
    y_data_p[i] = data[i]["principal component 2"];
    z_data_p[i] = data[i]["principal component 3"];
    text_p[i] = data[i]["Parties"];
}
...
var text_g = new Array(data.length);
var z_data_g = new Array(data.length);
var y_data_g = new Array(data.length);
var x_data_g = new Array(data.length);

for (var i = 28; i<36; i++) {
    x_data_g[i] = data[i]["principal component 1"];
    y_data_g[i] = data[i]["principal component 2"];
    z_data_g[i] = data[i]["principal component 3"];
    text_g[i] = data[i]["Parties"];
}
